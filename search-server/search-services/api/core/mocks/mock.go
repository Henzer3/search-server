...
//
//	mockgen -source=core/ports.go -destination=core/mocks/mock.go -package=mocks
//
...
func (m *MockSearcher) ISearch(arg0 context.Context, arg1 string, arg2 int) ([]core.ImageInformation, error) {
	m.ctrl.T.Helper()
...
func (m *MockSearcher) Search(arg0 context.Context, arg1 string, arg2 int) ([]core.ImageInformation, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthenticator) Login(name, password string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthenticatorMockRecorder) Login(name, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockAuthenticator)(nil).Login), name, password)
}
