...
func (m *MockPublisher) Publish(sub, data string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Publish", sub, data)
	ret0, _ := ret[0].(error)
	return ret0
}

// Publish indicates an expected call of Publish.
func (mr *MockPublisherMockRecorder) Publish(sub, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockPublisher)(nil).Publish), sub, data)
}
